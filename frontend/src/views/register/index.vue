<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin:0 0 30px 0;" @click="goLogin">去登录</el-button>
    </el-form>
  </div>
</template>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        userAccount: [{trigger: 'blur', validator: validateUsername }],
        userPassword: [{ trigger: 'blur', validator: validatePassword }],
