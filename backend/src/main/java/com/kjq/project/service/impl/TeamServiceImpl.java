...
import com.kjq.project.model.entity.UserTeam;
import com.kjq.project.model.enums.TeamStatusEnum;
import com.kjq.project.model.vo.TeamUserVO;
import com.kjq.project.model.vo.UserVO;
import com.kjq.project.service.TeamService;
import com.kjq.project.mapper.TeamMapper;
import com.kjq.project.service.UserService;
import com.kjq.project.service.UserTeamService;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
     ...
     */
    @Override
    public boolean updateTeam(TeamUpdateRequest teamUpdateRequest, User loginUser, HttpServletRequest request) {
    ...
    /**
     * 添加队伍的人数和判断当前用户是否加入该队伍列表
     * @param teamList
     * @param request
     * @return
     */
    @Override
    public List<TeamUserVO> countIsJoinTeam(List<TeamUserVO> teamList, HttpServletRequest request){
    ...
    /**
     * 加入队伍，通过分布式锁，来控制用户加入队伍的数量，防止队伍人数超过上限
